...
public class AccuracyFitness implements Fitness {
	...
	public AccuracyFitness(RobocodeEngine eng, String testRobo, String sampleRobo, int numRounds) {
	...
	public double fitness(Genome g) {
		...
		reporter.accuracyFileName = "../robocode/robots/neuro/" + robotName + ".data/accuracy.dat";
		...
		//eng.setVisible(true);
		//System.out.println(reporter.accuracy);
